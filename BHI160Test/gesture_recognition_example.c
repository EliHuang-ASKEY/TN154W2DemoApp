...
#else
static uint8_t out_buffer[OUT_BUFFER_SIZE] = " Time=xxx.xxxs Gesture: xxxxxxxxxx   \r\n";
#endif
...
#else
            strcpy_s((char *)&out_buffer[24], OUT_BUFFER_SIZE-24,"Glance    \r\n");
#endif
            break;
        case VS_TYPE_PICKUP:
#if 0  // Ammore Modify
...
#else
            strcpy_s((char *)&out_buffer[24], OUT_BUFFER_SIZE-24,"Pickup    \r\n");
#endif
            break;
...
#else
            strcpy_s((char *)&out_buffer[24], OUT_BUFFER_SIZE-24,"Sig motion\r\n");
#endif
            break;
        default:
#if 0  // Ammore Modify
...
#else
            strcpy_s((char *)&out_buffer[24], OUT_BUFFER_SIZE-24,"Unknown   \r\n");
#endif
            break;
    }
#if 0  // Ammore Modify
 ...
 */
int gesture_recognition_example_main(void)
{
