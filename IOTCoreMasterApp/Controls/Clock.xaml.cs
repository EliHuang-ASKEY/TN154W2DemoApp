...
namespace IOTCoreMasterApp.Controls
{
    public sealed partial class Clock : UserControl
    {
        ...
        private Windows.UI.Xaml.Shapes.Rectangle secondsHand;//繪製一個給定的高度和寬度與指定DIP(device-independent pixels)矩形
        ...
        private Brush rimBackground = new SolidColorBrush(Windows.UI.Colors.Gray);
