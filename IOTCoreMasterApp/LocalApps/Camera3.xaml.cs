...
namespace IOTCoreMasterApp.LocalApps
{
    ...
    /// 可以在本身使用或巡覽至框架內的空白頁面。
    /// </summary>
    public sealed partial class Camera3 : Page
    {
        ...
        private async void MediaCapture_Failed(MediaCapture sender, MediaCaptureFailedEventArgs errorEventArgs)
        {
            ...
            status.Text= "MediaCapture_Failed}";
        ...
        private async Task InitializeCameraAsync()
        {
            ...
            status.Text = "InitializeCameraAsync";
            ...
            if (_mediaCapture == null)
            {
                ...
                catch (UnauthorizedAccessException)
                {
                    ...
                    status.Text = "The app was denied access to the camera";
                }
        ...
        private async Task TakePhotoAsync()
        {
            ...
            try
            {
                ...
                status.Text = "Photo taken! Saving to " + file.Path;
            ...
            catch (Exception ex)
            {
                ...
                status.Text = "Exception when taking a photo: " + ex.ToString();
            }
        ...
        private async Task StartRecordingAsync()
        {
            try
            {
                ...
                status.Text = "Starting recording to " + videoFile.Path;

                await _mediaCapture.StartRecordToStorageFileAsync(encodingProfile, videoFile);
                _isRecording = true;

                Debug.WriteLine("Started recording!");
                status.Text = "Started recording!";
            }
            catch (Exception ex)
            {
                // File I/O errors are reported as exceptions
                Debug.WriteLine("Exception when starting video recording: " + ex.ToString());
                status.Text = "Exception when starting video recording: " + ex.ToString();
            }
        }
        ...
        */
        ...
        private async Task CleanupCameraAsync()
        {
            ...
            status.Text = "CleanupCameraAsync";
        ...
        private async void CloseShowImage(object sender, TappedRoutedEventArgs e)
        {
            await StartPreviewAsync();
